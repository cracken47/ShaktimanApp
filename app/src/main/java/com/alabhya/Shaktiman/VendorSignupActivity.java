...
public class VendorSignupActivity extends AppCompatActivity {
    ...
    private EditText fullName,password, mobileNumber, aadhar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tokenRequest.setFullName(fullName.getText().toString().trim());
                tokenRequest.setPassword(password.getText().toString().trim());
                tokenRequest.setPhone(mobileNumber.getText().toString().trim());
                tokenRequest.setStateId("1");
                tokenRequest.setCityId(""+cities.get(spinnerCity.getSelectedIndex()-1).getId());
                tokenRequest.setLocalityId(""+localities.get(spinnerLocality.getSelectedIndex()-1).getId());
                tokenRequest.setDob(dob.getText().toString().trim());
                tokenRequest.setAdharCard(aadhar.getText().toString().trim());
                tokenRequest.setIsLabour("0");

                Log.d("Single", tokenRequest.getPhone());*/
