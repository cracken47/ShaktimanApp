...
public class ProducerActiveOrderDetailsAdapter extends RecyclerView.Adapter<ProducerActiveOrderDetailsAdapter.MyViewHolder> {
    ...
    public ProducerActiveOrderDetailsAdapter(List<OrderDataProducer> orderDataProducers, Context ctx) {
        this.orderDataProducers = orderDataProducers;
        this.ctx = ctx;
    }
